angular.module("finishedtask.controller",[])
    .controller("finishedtaskCtrl", function($scope,$state, $ionicSideMenuDelegate, $ionicHistory) {
    ...
    .controller("finishedtaskInfoCtrl", function($scope, $state,$stateParams) {
    ...
    .controller("finishedtaskInfoHistoryCtrl", function($scope,$ionicHistory, $state,$stateParams) {
        $scope.finishedtaskInfo = angular.fromJson($stateParams.data);
        $scope.goBack = function() {
            $ionicHistory.goBack();
        };
    ...
    .controller("finishedtaskInfoPersonInfoCtrl", function($scope,$ionicHistory, $state,$stateParams) {
        $scope.finishedtaskInfo = angular.fromJson($stateParams.data);
        $scope.goBack = function() {
            $ionicHistory.goBack();
        };
    ...
    .controller("finishedtaskInfoAuditingCtrl", function($scope,$ionicHistory, $state,$stateParams,$http) {
        $scope.finishedtaskInfo = angular.fromJson($stateParams.data);
    ...
    .controller("finishedtaskInfoAuditingNextInfoCtrl", function($scope,$ionicHistory, $state,$stateParams) {
        $scope.finishedtaskInfo = angular.fromJson($stateParams.data);
        $scope.goBack = function() {
            $ionicHistory.goBack();
        };
    ...
    .controller("FinishedSynergyCluesCtrl", function($scope,$ionicHistory, $state,$stateParams) {
        $scope.goBack = function() {
            $ionicHistory.goBack();
        };
    })
    .controller("FinishedSynergyChanceCtrl", function($scope,$ionicHistory, $state,$stateParams) {
        $scope.goBack = function() {
            $ionicHistory.goBack();
        };
    })
