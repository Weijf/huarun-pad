angular.module("backlog.controller",[])
    .controller("backlogCtrl", function($scope,$state, $ionicSideMenuDelegate, $ionicHistory) {
        ...
        $scope.items = [{
            ...
            people: '刘能',
            date: '2017年6月6日',
            statusrc: 'img/backlog/yx.png',
            progresrc: 'img/backlog/yx.png',
            post: '客户经理',
            type:'yx',
            level:1,
            status: 2,
    ...
    .controller("SynergyCluesCtrl", function($scope,$ionicHistory, $state,$stateParams) {
        $scope.goBack = function() {
            $ionicHistory.goBack();
        };
    })
